...
namespace SecureDelete.Actions
{
	...
	public class SessionControlBridge : IBridge, IFullAccessBridge
	{
		...
		[BridgeMember(Name = "HostName", Signature = "public string HostName { get; }", Description = "Get the name of the host assembly.")]
		...
		[BridgeMember(Name = "ReportInsertActions", Signature = "public bool ReportInsertActions { get; set; }", Description = "Report insert actions to the session.")]
		...
		[BridgeMember(Name = "StopWipe", Signature = "public void StopWipe(string reason)", Description = "Abort the wipe operation.")]
		...
		[BridgeMember(Name = "InsertFile", Signature = "public void InsertFile(string path)", Description = "Add a file to the wipe list.")]
		...
		[BridgeMember(Name = "InsertFolder", Signature = "public void InsertFolder(string path, string pattern, bool regex, bool wipeSubfolders, bool deleteFolders)", Description = "Add a folder to the wipe list.")]
		...
		public void InsertFolder(string path, string pattern, bool regex, bool wipeSubfolders, bool deleteFolders)
		{
			...
			if (reportActions)
			{
				ActionErrorReporter.ReportError(_session, _afterWipe, ErrorSeverity.Low, FolderInsertOperation, path);
			}
		}


		[BridgeMember(Name = "InsertDrive", Signature = "public void InsertDrive(string name, bool wipeFreeSpace, bool wipeClusterTips, bool wipeMft)", Description = "Add a drive to the wipe list.")]
		...
		public void InsertDrive(char name, bool wipeFreeSpace, bool wipeClusterTips, bool wipeMft)
		{
			...
			if (reportActions)
			{
				ActionErrorReporter.ReportError(_session, _afterWipe, ErrorSeverity.Low, DriveInsertOperation, name);
			}
		}


		[BridgeMember(Name = "ReportError", Signature = "public void ReportError(int severity, string message)", Description = "Log an error message.")]
