...
namespace SecureDelete
{
	...
	{
		BeginStart, Wipe, Paused, Stopped, BeginActions, EndActions
	}
		...
		public FailedObject[] GetFailedObjects(bool getAssociatedError)
		{
			...
			if (context.IsOpen)
			{
				...
				if (valid)
				{
					...
					{
						KeyValuePair<NativeMethods.WSmallObject, NativeMethods.WError>[] failed = context.GetFailedObjectsWithErrors();
