...
namespace SecureDelete.FileSearch
{
	public class ExifReader
	{
		...
		{
			Correct, RotateRight, RotateLeft
		}
		...
		{
			NotDefined, Manual, Program, AperaturePriority, ShutterPriority,
			CreativeProgram, ActionProgram, PortaitMode, LandscapeMode
		}

		public enum MeteringMode
		{
			Unknown, AverageMetering, CenterWeightedAverageMetering, SpotMetering,
			MultiSpotMetering, MatrixMetering, PartialMetering
		}
