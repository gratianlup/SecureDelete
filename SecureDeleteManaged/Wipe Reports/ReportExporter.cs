	...
	class ReportExporter
	{
		...
		public static string GetHtmlString(WipeReport report, string style)
		{
			...
			if (report.Statistics != null)
			{
				...
				builder.Append("Start Time: "); builder.Append(report.Statistics.StartTime.ToString()); builder.AppendLine("<br/>");
				builder.Append("End Time: "); builder.Append(report.Statistics.EndTime.ToString()); builder.AppendLine("<br/>");
				builder.Append("Duration: "); builder.Append(report.Statistics.Duration.ToString()); builder.AppendLine("<br/>");
				builder.Append("Failed Objects: "); builder.Append(report.Statistics.FailedObjects); builder.AppendLine("<br/>");
				builder.Append("Errors: "); builder.Append(report.Statistics.Errors); builder.AppendLine("<br/>");
				builder.Append("Average Write Speed: "); builder.Append(report.Statistics.AverageWriteSpeed); builder.AppendLine("<br/>");
				builder.Append("Total Wiped Bytes: "); builder.Append(report.Statistics.TotalWipedBytes); builder.AppendLine("<br/>");
				builder.Append("Bytes In Cluster Tips: "); builder.Append(report.Statistics.BytesInClusterTips); builder.AppendLine("<br/>");
